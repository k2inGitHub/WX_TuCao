...
namespace CSVParser {
    ...
    public:
        ...
        // 每行数据有多少字段
        unsigned long size() const { return m_values.size(); }
    ...
    public:
        ...
        // 获取总行数
        unsigned long getRowCount() const { return m_content.size(); }
        // 获取总列数
        unsigned long getColumnCount() const { return m_header.size(); }
        // 运算符 [] 重载
